...
* The original package name 'com.rodrigo.dummy-migration-liquibase' is invalid and this project uses 'com.rodrigo.dummymigrationliquibase' instead.
...
* [Liquibase Migration](https://docs.spring.io/spring-boot/docs/2.5.10/reference/htmlsingle/#howto-execute-liquibase-database-migrations-on-startup)
